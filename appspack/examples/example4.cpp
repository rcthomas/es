/* $Id: example4.cpp,v 1.2 2006/06/30 01:07:26 tgkolda Exp $ */
/* $Source: /space/CVS-Acro/acro/packages/appspack/appspack/examples/example4.cpp,v $ */
...
/*! \file example4.cpp
   ...
   Example 4 function evaluation progam. This function evaluation
   ...
   \f[
   \begin{array}{ll}
   \min & (x_1 - 10)^2 + (x_2 - 10)^2 + (x_3 - 10)^2 + (x_4 - 10)^2\\
   \mbox{s.t.} &  -10 \le  -x_1 - x_2 - x_3 -x_4 \\
   & x_1 - x_2 + x_3 - x_4 \le -1 \\
   & 2x_1 + 2x_3 - 7x_4  = 3\\
   & -10 \leq x_i \leq 10 \mbox{ for } i=1,2,3,4
   \end{array}
   \f]
